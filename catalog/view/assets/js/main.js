(function ($) {
   ...
   /*---Newsletter Popup activation---*/
    ...
    $('.mini_cart_wrapper > a').on('click', function(){
        ...
        var html = '<div class="cart_gallery">';
        html += '<div class="cart_close">';
        html += '    <div class="cart_text">';
        html += '        <h3>cart</h3>';
        html += '    </div>';
        html += '    <div class="mini_cart_close">';
        html += '        <a href="javascript:void(0)"><i class="icon-x"></i></a>';
        html += '    </div>';
        html += '</div>';
        $.ajax({
			url: 'index.php?route=common/cart/cartfullinfo',
			type: 'get',
			...
			success: function(json) {
                ...
                for (let i in d.products) {
                                    
                    //Product start
                    html += '<div class="cart_item">';
                    html += '   <div class="cart_img">';
                    html += '       <a href="#"><img src="'+d.products[i]['thumb']+'" alt=""></a>';
                    html += '   </div>';
                    html += '    <div class="cart_info">';
                    html += '       <a href="#">'+d.products[i]['name']+'</a>';
                    html += '       <p>'+d.products[i]['quantity']+' x <span> '+d.products[i]['price']+' </span></p>    ';
                    html += '    </div>';
                    html += '   <div class="cart_remove">';
                    html += '       <button type="button" onclick="cart.remove('+d.products[i]['cart_id']+');" title="Remove" class="btn btn-danger btn-xs"><i class="fa fa-times"></i></button>';
                    html += '   </div>';
                    html += '</div>     '; 
                    //Product end
                }
                ...
                html += '<div class="cart_table_border">';

                for (let t in d.totals) {

                html += '    <div class="cart_total">';
                html += '        <span>'+d.totals[t]['title']+':</span>';
                html += '       <span class="price">'+d.totals[t]['text']+'</span>';
                html += '   </div>';
                }
                // html += '   <div class="cart_total mt-10">';
                // html += '       <span>total:</span>';
                // html += '       <span class="price">$125.00</span>';
                // html += '   </div>';


                html += '</div>';
                html += '</div>';
                html += '<div class="mini_cart_footer">';
                html += '<div class="cart_button">';
                html += '    <a href="index.php?route=checkout/cart"><i class="fa fa-shopping-cart"></i> View cart</a>';
                html += '</div>';
        ...
        // var t = ('#cart > ul').load('index.php?route=common/cart/info ul li');
        ...
        // html += '<div class="cart_item">';
        // html += '   <div class="cart_img">';
        // html += '       <a href="#"><img src="catalog/view/assets/img/s-product/product.jpg" alt=""></a>';
        // html += '   </div>';
        // html += '    <div class="cart_info">';
        // html += '       <a href="#">Primis In Faucibus</a>';
        // html += '       <p>1 x <span> $65.00 </span></p>    ';
        // html += '    </div>';
        // html += '   <div class="cart_remove">';
        // html += '       <a href="#"><i class="icon-x"></i></a>';
        // html += '   </div>';
        // html += '</div>     ';   
        // //Product end
        // html += '</div>';
        ...
        // html += '<div class="mini_cart_footer">';
        // html += '<div class="cart_button">';
        // html += '    <a href="cart.html"><i class="fa fa-shopping-cart"></i> View cart</a>';
        // html += '</div>';
        // html += '<div class="cart_button">';
        // html += '    <a href="checkout.html"><i class="fa fa-sign-in"></i> Checkout</a>';
        // html += '</div>';
        // html += '</div>';
        // alert('clicked');
        // $('.mini_cart,.off_canvars_overlay').addClass('active')
